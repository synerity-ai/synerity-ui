...
multiSelectedValue: string[] = [];`,
        ...
        },
  {
        ...
        name: 'Select Button',
        category: 'Form',
        description: 'Button group component for single or multiple selections with comprehensive theming, animations, and accessibility features',
        examples: [
          {
            name: 'Basic Select Button',
            code: '<sui-select-button\n  [options]="options"\n  [(ngModel)]="selectedValue"\n  label="Choose an option">\n</sui-select-button>',
            description: 'Simple select button group with basic functionality'
          },
          {
            name: 'Multi-Select with Icons',
            code: '<sui-select-button\n  [options]="iconOptions"\n  [(ngModel)]="selectedValues"\n  [multiple]="true"\n  label="Select formatting options">\n</sui-select-button>',
            description: 'Multi-select buttons with icons for text formatting'
          },
          {
            name: 'Size Variations',
            code: '<div class="space-y-4">\n  <sui-select-button [options]="options" size="sm" label="Small"></sui-select-button>\n  <sui-select-button [options]="options" size="md" label="Medium"></sui-select-button>\n  <sui-select-button [options]="options" size="lg" label="Large"></sui-select-button>\n</div>',
            description: 'Select buttons in different sizes'
          },
          {
            name: 'Color Themes',
            code: '<div class="space-y-4">\n  <sui-select-button [options]="options" color="primary" label="Primary"></sui-select-button>\n  <sui-select-button [options]="options" color="success" label="Success"></sui-select-button>\n  <sui-select-button [options]="options" color="warning" label="Warning"></sui-select-button>\n  <sui-select-button [options]="options" color="danger" label="Danger"></sui-select-button>\n</div>',
            description: 'Select buttons with different color themes'
          },
          {
            name: 'Style Variations',
            code: '<div class="space-y-4">\n  <sui-select-button [options]="options" style="default" label="Default"></sui-select-button>\n  <sui-select-button [options]="options" style="outline" label="Outline"></sui-select-button>\n  <sui-select-button [options]="options" style="ghost" label="Ghost"></sui-select-button>\n</div>',
            description: 'Select buttons with different styles'
          },
          {
            name: 'Shape Variations',
            code: '<div class="space-y-4">\n  <sui-select-button [options]="options" shape="default" label="Default"></sui-select-button>\n  <sui-select-button [options]="options" shape="rounded" label="Rounded"></sui-select-button>\n  <sui-select-button [options]="options" shape="pill" label="Pill"></sui-select-button>\n</div>',
            description: 'Select buttons with different shapes'
          },
          {
            name: 'Animation Effects',
            code: '<div class="space-y-4">\n  <sui-select-button [options]="options" [animated]="true" label="Animated"></sui-select-button>\n  <sui-select-button [options]="options" [bounce]="true" label="Bounce"></sui-select-button>\n  <sui-select-button [options]="options" [glow]="true" label="Glow"></sui-select-button>\n</div>',
            description: 'Select buttons with different animation effects'
          },
          {
            name: 'Real-World Example - Text Editor',
            code: '<sui-select-button\n  [options]="formattingOptions"\n  [(ngModel)]="selectedFormats"\n  [multiple]="true"\n  size="sm"\n  style="outline"\n  label="Text Formatting"\n  helperText="Select text formatting options">\n</sui-select-button>',
            tsCode: `interface FormattingOption {
    label: string;
    value: string;
    icon: string;
  }
  ...
  export class TextEditorComponent {
    selectedFormats: string[] = ['bold', 'italic'];
    ...
    onFormatChange(formats: string[]): void {
      ...
      // Apply formatting to selected text
            ...
            description: 'Text editor formatting toolbar using select buttons'
          },
          {
            name: 'Real-World Example - View Selector',
            code: '<sui-select-button\n  [options]="viewOptions"\n  [(ngModel)]="currentView"\n  color="primary"\n  shape="rounded"\n  [animated]="true"\n  label="View Mode"\n  helperText="Choose how to display items">\n</sui-select-button>',
            tsCode: `interface ViewOption {
    label: string;
    value: string;
    icon: string;
  }
        ...
        props: [
          {
            ...
            default: '[]',
            description: 'Array of options to display in the select button group',
            required: true
          },
          {
            name: 'multiple',
          ...
          },
          {
            ...
            type: '"sm" | "md" | "lg"',
            default: '"md"',
            description: 'Size of the select buttons',
            required: false
          },
          {
            name: 'color',
            ...
            default: '"default"',
            description: 'Color theme for the select buttons',
            required: false
          },
          {
            name: 'style',
            ...
            default: '"default"',
            description: 'Visual style of the select buttons',
            required: false
          },
          {
            name: 'shape',
            ...
            default: '"default"',
            description: 'Shape of the select buttons',
            required: false
          },
          {
            name: 'theme',
            type: '"light" | "dark"',
            default: '"light"',
            description: 'Theme variant for the select buttons',
            required: false
          },
          {
            name: 'label',
            type: 'string',
            default: '""',
            description: 'Label text for the select button group',
            required: false
          },
          {
            name: 'helperText',
            type: 'string',
            default: '""',
            description: 'Helper text displayed below the select buttons',
            required: false
          },
          {
            name: 'errorText',
          ...
          },
          {
            ...
            type: 'boolean',
            default: 'false',
            description: 'Disable the entire select button group',
            required: false
          },
          {
            name: 'loading',
          ...
          },
          {
            ...
            type: 'boolean',
            default: 'false',
            description: 'Use spacious layout with increased spacing',
            required: false
          },
          {
            name: 'animated',
            type: 'boolean',
            default: 'false',
            description: 'Enable smooth hover animations',
            required: false
          },
          {
            name: 'bounce',
            type: 'boolean',
            default: 'false',
            description: 'Enable bounce animation on hover',
            required: false
          },
          {
            name: 'glow',
            type: 'boolean',
            default: 'false',
            description: 'Enable glow effect on focus',
            required: false
          },
          {
            name: 'ariaLabel',
            type: 'string',
            default: '""',
            description: 'Accessibility label for the select button group',
            required: false
          },
          {
            ...
            type: 'string | null',
            default: 'null',
            description: 'ID of element that describes the select button group',
            required: false
          }
        ],
        events: [
          ...
          },
          {
            name: 'onFocus',
            type: 'number',
            description: 'Emitted when focus moves to a button (index)'
          },
          {
            name: 'onBlur',
            type: 'void',
            description: 'Emitted when focus leaves the button group'
          }
        ],
        usage: 'Use select buttons for single or multiple choice selections where you want a more visual, button-like interface. Perfect for toolbars, view selectors, formatting options, and any scenario where you need clear visual feedback for selections.',
        tags: ['select-button', 'form', 'input', 'button-group', 'multi-select', 'selection', 'toolbar']
      },
  {
        id: 'rating',
        name: 'Rating',

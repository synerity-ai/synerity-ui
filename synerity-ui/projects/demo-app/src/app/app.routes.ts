...
export const routes: Routes = [
  ...
  { path: 'components/paginator', loadComponent: () => import('./pages/paginator/paginator').then(m => m.Paginator) },
  { path: 'components/picklist', loadComponent: () => import('./pages/picklist/picklist').then(m => m.Picklist) },
  { path: 'components/timeline', loadComponent: () => import('./pages/timeline/timeline').then(m => m.Timeline) },
  { path: 'components/tree', loadComponent: () => import('./pages/tree/tree').then(m => m.Tree) },
  { path: 'components/treetable', loadComponent: () => import('./pages/treetable/treetable').then(m => m.Treetable) },
  { path: 'components/virtualscroller', loadComponent: () => import('./pages/virtualscroller/virtualscroller').then(m => m.Virtualscroller) },
  ...
  { path: 'components/tabs', loadComponent: () => import('./pages/tabs/tabs').then(m => m.Tabs) },
  ...
  { path: 'components/confirmpopup', loadComponent: () => import('./pages/confirmpopup/confirmpopup').then(m => m.Confirmpopup) },
  { path: 'components/dialog', loadComponent: () => import('./pages/dialog/dialog').then(m => m.DialogPage) },
  { path: 'components/drawer', loadComponent: () => import('./pages/drawer/drawer').then(m => m.Drawer) },
  { path: 'components/dynamicdialog', loadComponent: () => import('./pages/dynamicdialog/dynamicdialog').then(m => m.Dynamicdialog) },
  { path: 'components/popover', loadComponent: () => import('./pages/popover/popover').then(m => m.Popover) },
  ...
  { path: 'components/overlays', loadComponent: () => import('./pages/overlays/overlays').then(m => m.Overlays) },
